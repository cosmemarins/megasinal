...
async function updateUser(id, newUser) {
    ...
    if (newUser.phone && newUser.phone !== currentUser.phone)
        currentUser.phone = newUser.phone;

    if (newUser.telegramChat && newUser.telegramChat !== currentUser.telegramChat)
    ...
    if (newUser.accessKey && newUser.accessKey !== currentUser.accessKey)
        currentUser.accessKey = newUser.accessKey;

    if (newUser.pushToken !== undefined && newUser.pushToken !== currentUser.pushToken)
