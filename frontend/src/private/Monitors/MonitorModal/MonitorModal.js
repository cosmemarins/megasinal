                            ...
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    <div className="form-group mb-4">
                                        <MonitorType onChange={onInputChange} type={monitor.type} disabled={monitor.id > 0} />
                                    </div>
                                </div>
                                {
                                    monitor.type === 'CANDLES' || monitor.type === 'TICKER'
                                        ? <div className="col-md-6 mb-3">
                                            <div className="form-group mb-4">
                                                ...
                                                <SelectSymbol onChange={onInputChange} symbol={monitor.symbol} onlyFavorites={false} disabled={monitor.id > 0} />
                                            </div>
                                        </div>
