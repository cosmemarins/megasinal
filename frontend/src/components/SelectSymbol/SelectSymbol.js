...
function SelectSymbol(props) {
    ...
    useEffect(() => {
        const isWildcard = props.symbol ? props.symbol.startsWith('*') : false;
        ...
        return (
            <React.Fragment>
                <div className="input-group mb-3">
                    ...
                    {
                        quote
                            ? <SelectQuote value={quote} disabled={props.disabled} noFavorites={true} onChange={onQuoteChange} />
                            : <React.Fragment></React.Fragment>
                    }
                </div>
