                    ...
                    <div className="modal-body">
                        <div className="form-group">
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    <div className="form-group">
                                        ...
                                        <SelectSymbol symbol={order.symbol} onlyFavorites={false} showAny={false} disabled={false} onChange={onSymbolChange} />
                                    </div>
                                </div>
                                <div className="col-md-6 mb-3">
                                    {
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6 mb-3">
                                    <QuantityInput id="quantity" text="Quantity:" quantity={order.quantity} side={order.side} symbol={symbol} wallet={wallet} price={order.limitPrice} onChange={onInputChange} />
                                </div>
                            </div>
                            <div className="row">
                                <div className={getIcebergClasses(order.type)}>
                                    <QuantityInput id="icebergQty" text="Iceberg Qty:" quantity={order.quantity} side={order.side} symbol={symbol} wallet={wallet} price={order.limitPrice} onChange={onInputChange} />
                                </div>
